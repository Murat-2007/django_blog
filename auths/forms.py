...
class RegisterForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        if User.objects.filter(email=email).exists():
            #self.add_error('email', 'Bu email sistemde kayıtlı!')
    ...
    def clean_username(self):
        ...
        if User.objects.filter(username=username).exists():
            #self.add_error('username', 'Bu kullanici sistemde mevcut!')
            raise forms.ValidationError('Bu kullanici sistemde mevcut')
        return username
...
class LoginForm(forms.Form):
    ...
    def clean(self):
        ...
        if not user:
            raise forms.ValidationError('Hatali kullanici adi veya sifre girdiniz')
